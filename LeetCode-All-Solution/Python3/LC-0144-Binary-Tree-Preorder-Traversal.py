...
@File    : LC-0144-Binary-Tree-Preorder-Traversal.py
...
"""
LeetCode - 0144 - (Easy) - Binary Tree Preorder Traversal
...
class Solution:
    def preorderTraversal(self, root: Optional[TreeNode]) -> List[int]:
        ...
        # main method: (DFS preorder Traversal)
...
def main():
    ...
    ans = solution.preorderTraversal(root_node)
