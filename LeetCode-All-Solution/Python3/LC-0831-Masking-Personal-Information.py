...
@File    : LC-0831-Masking-Personal-Information.py
...
"""
LeetCode - 0831 - (Medium) - Masking Personal Information
...
class Solution:
    def maskPII(self, s: str) -> str:
        ...
        return self._maskPII(s)

    def _maskPII(self, s: str) -> str:
        assert isinstance(s, str) and len(s) >= 1
...
def main():
    # Example 1: Output: "l*****e@leetcode.com"
    s = "LeetCode@LeetCode.com"

    # Example 2: Output: "a*****b@qq.com"
    # s = "AB@qq.com"

    # Example 3: Output: "***-***-7890"
    # s = "1(234)567-890"
