...
@File    : LC-0145-Binary-Tree-Postorder-Traversal.py
...
"""
LeetCode - 0145 - (Easy) - Binary Tree Postorder Traversal
...
class Solution:
    def postorderTraversal(self, root: Optional[TreeNode]) -> List[int]:
        ...
        # main method: (DFS postorder Traversal)
...
def main():
    ...
    ans = solution.postorderTraversal(root_node)
