...
@File    : LC-1237-Find-Positive-Integer-Solution-for-a-Given-Equation.py
...
"""
LeetCode - 1237 - (Medium) - Find Positive Integer Solution for a Given Equation
...
class Solution:
    def findSolution(self, customfunction: CustomFunction, z: int) -> List[List[int]]:
        ...
        return self._findSolution(customfunction, z)

    def _findSolution(self, customfunction: CustomFunction, z: int) -> List[List[int]]:
        assert isinstance(z, int) and z >= 1
...
def main():
    # Example 1: Output: [[1,4],[2,3],[3,2],[4,1]]
    function_id = 1
    z = 5

    # Example 2: Output: [[1,5],[5,1]]
    # function_id = 2
    # z = 5

    func = CustomFunction(function_id)
    ...
    ans = solution.findSolution(func, z)
