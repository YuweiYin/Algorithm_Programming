...
@File    : LC-0098-Validate-Binary-Search-Tree.py
...
"""
LeetCode - 0098 - (Medium) - Validate Binary Search Tree
...
class Solution:
    def isValidBST(self, root: Optional[TreeNode]) -> bool:
        ...
        if not isinstance(root, TreeNode):
            return False
        # main method: (in-order traverse, increasing list <=> BST tree)
...
def main():
    ...
    ans = solution.isValidBST(root_node)
